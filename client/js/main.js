...
(function () {
  ...
  var CATALOG = [
    { id: 'tic-tac-toe', name: 'TIC TAC TOE', tagline: 'Three in a row. The classic standoff.', accent: '#ff2d9b', badge: 'ONLINE' },
    { id: 'connect-four', name: 'CONNECT 4', tagline: 'Drop discs, line up four to win.', accent: '#ffb000', badge: 'ONLINE' },
    { id: 'rps', name: 'RPS DUEL', tagline: 'Rock paper scissors, best of five.', accent: '#2de2ff', badge: 'ONLINE' },
    { id: 'memory', name: 'MEMORY', tagline: 'Flip cards, match pairs, sharpest mind wins.', accent: '#b14bff', badge: 'ONLINE' },
    { id: 'checkers', name: 'CHECKERS', tagline: 'Jump and capture across the board.', accent: '#ff5a5a', badge: '2P' },
    { id: 'reversi', name: 'REVERSI', tagline: 'Flank to flip. Own the board.', accent: '#39ff8b', badge: '2P' },
    { id: 'dots', name: 'DOTS & BOXES', tagline: 'Close a box, claim it, take another turn.', accent: '#ff2d9b', badge: '2P' },
    { id: 'battleship', name: 'BATTLESHIP', tagline: 'Hide your fleet. Sink theirs first.', accent: '#2de2ff', badge: '2P' },
    { id: 'pong', name: 'PONG', tagline: 'Reflex paddle classic. First to 7.', accent: '#ffb000', badge: '2P' },
    { id: 'drawing', name: 'DOODLE', tagline: 'Draw together on a shared canvas.', accent: '#39ff8b', badge: 'ONLINE' },
    { id: 'sugar', name: 'SUGAR RUSH', tagline: 'Draw lines, pour sugar, fill your cup first.', accent: '#ff5a5a', badge: 'ONLINE' }
  ];
  ...
  function sfx(kind) {
    switch (kind) {
      case 'hover': tone(620, 0.04, 'square', 0.025); break;
      case 'click': tone(440, 0.07, 'square', 0.05, 660); break;
      case 'place': tone(330, 0.09, 'triangle', 0.07, 520); break;
      case 'drop': tone(200, 0.16, 'sawtooth', 0.06, 90); break;
      case 'flip': tone(700, 0.06, 'square', 0.04, 900); break;
      case 'match': tone(660, 0.1, 'square', 0.06, 990); setTimeout(function () { tone(990, 0.12, 'square', 0.06); }, 90); break;
      case 'win': [523, 659, 784, 1047].forEach(function (f, i) { setTimeout(function () { tone(f, 0.16, 'square', 0.07); }, i * 110); }); break;
      case 'lose': [400, 320, 240].forEach(function (f, i) { setTimeout(function () { tone(f, 0.18, 'sawtooth', 0.06); }, i * 130); }); break;
      case 'beep': tone(880, 0.12, 'square', 0.07); break;
      case 'go': tone(1200, 0.25, 'square', 0.09, 1600); break;
      case 'error': tone(160, 0.18, 'sawtooth', 0.06); break;
    }
  }
  ...
  function buildCabinet(meta) {
    ...
    return h('div', {
      ...
      onMouseEnter: function (e) { e.currentTarget.style.transform = 'translateY(-7px)'; e.currentTarget.style.borderColor = a; e.currentTarget.style.boxShadow = '0 18px 46px -12px ' + a; },
      onMouseLeave: function (e) { e.currentTarget.style.transform = 'none'; e.currentTarget.style.borderColor = 'rgba(255,255,255,.08)'; e.currentTarget.style.boxShadow = 'none'; }
    }, [
      ...
      h('div', { class: 'cab-screen', style: { boxShadow: 'inset 0 0 24px rgba(0,0,0,.9),0 0 0 1px ' + a + '33' } }, [
        h('div', { class: 'scan' }),
        h('div', { class: 'cab-badge', style: { color: a, border: '1px solid ' + a } }, meta.badge),
      ...
      h('div', { class: 'cab-door' }, [
        ...
        h('div', { class: 'start', style: { color: a } }, 'PRESS START')
      ])
    ]);
  }
  function buildLobby() {
  ...
  function setMode(m) {
    ...
    document.getElementById('mode-hint').textContent = m === 'local'
      ...
      : 'Matchmake with a 2nd browser. Every game plays online.';
  }
  ...
  function enterGame(id) {
    ...
    document.getElementById('mode-badge').textContent = online ? '🌐 ONLINE' : '🎮 LOCAL 2P';
